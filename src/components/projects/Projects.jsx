...
const Projects = () => {
  return (
    ...
    >
      <h3 className="text-5xl lg:text-7xl md:text-center lg:text-center font-bold">
        My{' '}
      ...
      <div className="proj-cards grid md:grid-cols-2 gap-10 mt-16">
        {projectsArr.map((project) => (
          <div className="card border rounded-md border-gray-500 p-2 flex flex-col items-center shadow-md hover:shadow-lg transition-shadow hover:shadow-lg transition-shadow transform hover:scale-105"  key={project.id}>
